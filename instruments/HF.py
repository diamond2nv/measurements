...
class WavelengthMeter:
    ...
    def GetAll(self,channel=1):
        return {
            "debug": self.debug,
            "wavelength": self.GetWavelength(channel),
            "frequency": self.GetFrequency(channel),
...
#    args = parser.parse_args()
    ...
    wlm = WavelengthMeter()
    print(wlm.wavelengths[1:6:1])
    print (wlm.GetAll(channel=2))
