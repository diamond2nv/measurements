...
class Ui_Panel(object):
    def setupUi(self, Panel):
        ...
        self.label_view_time.setGeometry(QtCore.QRect(420, 620, 151, 21))
        font = QtGui.QFont()
        ...
        self.botton_zoom_in.setGeometry(QtCore.QRect(600, 710, 61, 51))
        font = QtGui.QFont()
        ...
        self.button_full_view.setGeometry(QtCore.QRect(600, 650, 131, 51))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        ...
        self.dsb_t1 = QtWidgets.QDoubleSpinBox(Panel)
        self.dsb_t1.setGeometry(QtCore.QRect(420, 690, 81, 31))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(11)
        self.dsb_t1.setFont(font)
        self.dsb_t1.setObjectName("dsb_t1")
        ...
        self.comboBox_units_t1 = QtWidgets.QComboBox(Panel)
        self.comboBox_units_t1.setGeometry(QtCore.QRect(510, 690, 73, 31))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(11)
        self.comboBox_units_t1.setFont(font)
        self.comboBox_units_t1.setObjectName("comboBox_units_t1")
        self.dsb_t0 = QtWidgets.QDoubleSpinBox(Panel)
        self.dsb_t0.setGeometry(QtCore.QRect(420, 650, 81, 31))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(11)
        self.dsb_t0.setFont(font)
        self.dsb_t0.setObjectName("dsb_t0")
        ...
        self.comboBox_units_t0 = QtWidgets.QComboBox(Panel)
        self.comboBox_units_t0.setGeometry(QtCore.QRect(510, 650, 73, 31))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(11)
        self.comboBox_units_t0.setFont(font)
        self.comboBox_units_t0.setObjectName("comboBox_units_t0")
        ...
        self.button_zoom_out.setGeometry(QtCore.QRect(670, 710, 61, 51))
        font = QtGui.QFont()
        ...
        self.button_set_interval = QtWidgets.QPushButton(Panel)
        self.button_set_interval.setGeometry(QtCore.QRect(420, 730, 161, 28))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(12)
        self.button_set_interval.setFont(font)
        self.button_set_interval.setObjectName("button_set_interval")
    ...
    def retranslateUi(self, Panel):
        ...
        self.button_set_interval.setText(_translate("Panel", "set interval"))
